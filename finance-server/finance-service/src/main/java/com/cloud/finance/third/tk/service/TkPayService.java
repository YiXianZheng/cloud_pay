...
/**
 * @description: tk商务平台支付
 * @author: zyx
 * @create: 2019-04-04 22:15
 **/
@Service("TkPayService")
public class TkPayService implements BasePayService {

    private static Logger logger = LoggerFactory.getLogger(TkPayService.class);
    ...
    public MidPayCreateResult createQrCode(ThirdChannelDto thirdChannelDto, ShopPayDto shopPayDto) {
        logger.info("[tk create gateSyt params]:channelId:" + thirdChannelDto.getId() + ", sysOrderNo:" + shopPayDto.getSysPayOrderNo());
        ...
        String actionRespUrl = getBasePayUrl() + "/d8/tk_" + shopPayDto.getSysPayOrderNo() + ".html";
