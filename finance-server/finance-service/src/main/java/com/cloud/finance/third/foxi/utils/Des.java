package com.cloud.finance.third.foxi.utils;
...
/**
	...
	public static String  getMd5Data(Map<String,Object> map) throws Exception {
		...
		String signContent = sb.toString()+ workKey;
